#!usr/bin/python3.7
#Author: Isal-Isal ©2019
#contact: 081221353640
#github: github.com/ID-Arif
try:
...
def banner():
	...
	print(cyan('  / __(_)  |/  / _ )/ __/ ',bold=True),green('Author : Arief-Isal',bold=True))
	print(cyan(' _\ \/ / /|_/ / _  / _/	  ',bold=True),green('Contact: 081221353640',bold=True))
